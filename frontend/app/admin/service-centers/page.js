    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm shadow-slate-200/50 sm:flex-row sm:flex-wrap sm:items-center">
        ...
        <select
          ...
          className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-black focus:border-electric-400 focus:bg-white focus:outline-none focus:ring-1 focus:ring-electric-400 sm:w-auto">
      ...
      {/* Table */}
      <div className="w-full overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-sm shadow-slate-200/50">
