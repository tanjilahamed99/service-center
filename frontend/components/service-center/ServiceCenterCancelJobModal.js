...
export default function ServiceCenterCancelJobModal({
  open,
  onClose,
  job,
  onCancelJob,
  ...
  function handleSubmit(e) {
    e.preventDefault();
    onCancelJob?.({ jobId: job?._id, reason });
    setReason("");
    onClose?.();
  }
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg text-black border border-gray-500 bg-slate-50 px-3 py-2 text-sm focus:border-red-400 focus:bg-white focus:outline-none focus:ring-1 focus:ring-red-400"
          />
        </div>
